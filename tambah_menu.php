...
<head>
    ...
    <style>
        ...
        #header {
            ...
            background-color: var(--accent-blue); /* Warna latar header */
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Navbar dengan Teks Putih</title>
    <style>
        /* Mengatur teks navbar menjadi putih */
        #user-nav .nav a {
            color: white !important; /* Warna teks putih */
        }

        /* Mengatur teks dropdown menjadi hitam */
        #user-nav .dropdown-menu a {
            color: black !important; /* Warna teks hitam di dropdown */
        }

        /* Hover efek untuk dropdown */
        #user-nav .dropdown-menu a:hover {
            color: blue !important; /* Warna biru saat hover */
        }
    </style>
</head>
<body>
