...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Header dengan Logo Warmindo</title>
    <style>
        /* CSS untuk header */
        #header {
...
<head>
    ...
    <style>
        /* CSS untuk teks warna putih */
        #user-nav .nav a {
            color: white; /* Mengubah warna teks menjadi putih */
        }

        #user-nav .nav a:hover {
            color: #f8f9fa; /* Warna teks saat hover (opsional) */
        }

        #user-nav .dropdown-menu a {
            color: black; /* Warna teks di dropdown menjadi hitam */
        }

        #user-nav .dropdown-menu a:hover {
            color: blue; /* Warna saat hover di dropdown */
        }
    </style>
</head>
<body>
