...
<html lang="en">
<head>
	<title>Masuk || Warmindo TUP</title>
	<meta charset="UTF-8">
...
<body>
	<div class="limiter">
		<div class="container-login100" style="background-image: url('template/masuk/images/background.png');">
			<div class="wrap-login100 p-t-120 p-b-30">
				<form action="" method="post" class="login100-form validate-form">
					...
					<img src="template/masuk/images/logo2.png" alt="LOGO2">
					</div>
