...
<html lang="en">
<head>
	<title>Masuk || Warmindo Telkom University Purwokerto</title>
	<meta charset="UTF-8">
...
<body>
	<div class="limiter">
		<div class="container-login100" style="background-image: url('template/masuk/images/backgroundwarkom.jpg');">
			<div class="wrap-login100 p-t-120 p-b-30">
				<form action="" method="post" class="login100-form validate-form">
					...
					<img src="template/masuk/images/logo.png" alt="LOGO">
					</div>

					<span class="login100-form-title p-t-20 p-b-45">
						Warmindo Telkom University Purwokerto
					</span>
